...
//
// Every hex is a locked brand value from
// ~/Projects/selr-brand-ecosystem/brand/brand-tokens.json. Nothing here is invented.

export const RAMPS = {
  'Purple/100': '#F2EDFF', 'Purple/200': '#D5C4FF', 'Purple/400': '#9B73FF',
  'Purple/500': '#7E4BFF', 'Purple/600': '#6736E2', 'Purple/700': '#5024C0',
  'Purple/800': '#3C159E', 'Purple/900': '#230670',

  'Gray/Cloud': '#EDEFF7', 'Gray/Smoke': '#D3D6E0', 'Gray/Steel': '#BCBFCC',
  'Gray/Space': '#9DA2B3', 'Gray/Graphite': '#6E7180', 'Gray/Arsenic': '#40424D',
  'Gray/Phantom': '#1E1E24', 'Gray/Black': '#0A0A0A', 'Gray/True': '#000000',

  'Neutral/100': '#F8F8F8', 'Neutral/200': '#EDEDED', 'Neutral/400': '#ABABAB',
...
export const SEMANTIC = {
  ...
  'Background/Button/primary-pressed':   ['Purple/800',  'Purple/800'],
...
export const RADIUS = { '3XS': 2, '2XS': 4, 'XS': 6, 'S': 8, 'M': 12, 'L': 16,
                        'XL': 20, '2XL': 24, '3XL': 32, '4XL': 40, 'Full': 360 };

// [name, size, weight role, letter-spacing in em]
export const TYPE = [
  ['Marketing/Heading 1',   64, 'semibold', -0.02],
  ['Marketing/Heading 2',   48, 'semibold', -0.02],
  ['Marketing/Subheader 1', 32, 'semibold', -0.02],
  ['Marketing/Subheader 2', 24, 'semibold', -0.02],
  ['Marketing/Paragraph 1', 18, 'regular',   0],
  ['Marketing/Paragraph 2', 16, 'regular',   0],
  ['UI/Header 1', 32, 'semibold', 0],
  ['UI/Header 2', 24, 'semibold', 0],
  ['UI/Header 3', 20, 'semibold', 0],
  ['UI/Header 4', 17, 'semibold', 0],
  ['UI/Header 5', 15, 'semibold', 0],
  ['UI/Title 1',  20, 'medium',   0],
  ['UI/Title 2',  18, 'medium',   0],
  ['UI/Title 3',  15, 'medium',   0],
  ['UI/Body',     15, 'regular',  0],
  ['UI/Caption',  12, 'medium',   0]
];
